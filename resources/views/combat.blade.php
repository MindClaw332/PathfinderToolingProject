    ...
    <div class="combat-manager" x-data="combatManager">
        ...
        <div class="tutorial-popup" :class="{ 'visible': tutorialActive }">
            ...
            <div class="tutorial-buttons">
                <button x-show="currentTutorialIndex > 0" @click="prevTutorialStep" class="btn btn-secondary">
                    <i class="fas fa-arrow-left mr-1"></i> Previous
                </button>
                <button x-show="currentTutorialIndex === tutorialSteps.length - 1" @click="endTutorial"
                    class="btn btn-primary">
                    Finish Tutorial
                </button>
                <button x-show="currentTutorialIndex < tutorialSteps.length - 1" @click="nextTutorialStep"
                    class="btn btn-primary">
        ...
        <div class="creature-modal" :class="{ 'visible': showAddCreatureModal }">
            <div class="modal-content">
                ...
                <div class="tabs-container">
                    <button @click="activeTab = 'monsters'"
                        :class="{
                            'tab-button': true,
                ...
                <div class="modal-body">
                    ...
                    <div x-show="activeTab === 'monsters'">
                        <div class="search-container">
                            <input type="text" x-model="creatureSearch" placeholder="Search creatures by name..."
                                class="search-input" @input="filterCreatures">
                        </div>
                        ...
                        <div class="player-form">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" x-model="playerForm.name" placeholder="Character name">
                                </div>

                                <div class="form-group">
                                    <label>Class</label>
                                    <input type="text" x-model="playerForm.class" placeholder="Class">
                                </div>

                                <div class="form-group">
                                    <label>Level</label>
                                    <input type="number" x-model="playerForm.level" min="1" placeholder="Level">
                                </div>

                                <div class="form-group">
                                    <label>Armor Class (AC) *</label>
                                    <input type="number" x-model="playerForm.ac" min="0" placeholder="AC">
                                </div>

                                <div class="form-group">
                                    <label>Max HP *</label>
                                    <input type="number" x-model="playerForm.maxHp" min="1"
                                        placeholder="Max HP">
                                </div>

                                <div class="form-group">
                                    <label>Perception Bonus</label>
                                    <input type="number" x-model="playerForm.perception" placeholder="Perception">
                                </div>

                                <div class="form-group">
                                    <label>Speed</label>
                                    <input type="text" x-model="playerForm.speed" placeholder="e.g. 25 ft">
                                </div>

                                <div class="form-group">
                                    <label>Saving Throws</label>
                                    <input type="text" x-model="playerForm.saves"
                                        placeholder="Fort +X, Ref +Y, Will +Z">
                                </div>
                            </div>

                            <div class="form-actions">
                                <button @click="resetPlayerForm" class="btn btn-secondary">
                                    Reset
                                </button>
                                <button @click="addPlayerCombatant" class="btn btn-primary"
            ...
            <div class="csv-modal-content">
                ...
                <div class="csv-modal-body">
                    <div class="csv-import-instructions">
                        ...
                        <p>1. Your CSV file should have the following columns:
                            <code>name,type,ac,maxHp,currentHp,initiative,initiativeBonus,speed,perception,saves,fortSave,refSave,willSave,actions,conditions,class,level</code>
                        </p>
                    ...
                    <div class="csv-import-actions">
                        <button class="btn btn-secondary" @click="showCsvImportModal = false">
                            Cancel
                        </button>
        ...
        <div class="scroll-to-info" @click="scrollToDetails" :class="{ 'hidden': !selectedCombatant }"
        ...
        <div class="header">
            ...
            <div class="custom-dice-roller">
                ...
                <div class="custom-dice-controls">
                    <input type="text" x-model="customDiceExpression" placeholder="e.g. 3d6+2"
                        class="custom-dice-input" @keyup.enter="rollCustomDice">
        ...
        <div class="turn-order">
            <template x-for="(combatant, index) in combatants" :key="combatant.id">
                <div @click="setCurrentTurnAndScroll(index, combatant)"
                    :class="{
                        'turn-item': true,
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 combatants-section">
                ...
                <div class="combatants-grid">
                    <template x-for="combatant in combatants" :key="combatant.id">
                        <div @click="selectCombatant(combatant)"
                            :class="{
                                'combatant-card': true,
                            ...
                            <div class="combatant-stats">
                                <div class="combatant-stat">
                                    ...
                                    <button @click.stop="rollInitiative(combatant)" class="initiative-roll-btn"
                            ...
                            <div class="mt-1">
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <div class="flex items-center">
                                        <input type="number" x-model="combatant.currentHp"
                                            class="w-16 text-center border rounded py-1 px-2 text-sm" min="0"
                                            :max="combatant.maxHp">
                                ...
                                <div class="hp-bar-container">
                                    <div class="hp-bar"
                                        :style="'width: ' + (combatant.currentHp / combatant.maxHp * 100) + '%'"></div>
                                </div>

                                <div class="hp-controls">
                                    <button @click.stop="adjustHP(combatant, -1)" class="hp-btn text-xs">
                                        -1
                                    </button>
                                    <button @click.stop="adjustHP(combatant, -5)" class="hp-btn text-xs">
                                        -5
                                    </button>
                                    <button @click.stop="adjustHP(combatant, 5)" class="hp-btn text-xs">
                                        +5
                                ...
                                <div class="conditions-section">
                                    ...
                                    <input type="text" x-model="combatant.conditions"
                                ...
                                <div class="combatant-actions">
                                    ...
                                    <button class="combatant-action-btn"
                                        @click.stop="addCondition(combatant, 'Flat-footed')">
                                        Flat-footed
                                    </button>
                                    <button class="combatant-action-btn"
                                        @click.stop="addCondition(combatant, 'Stunned')">
                                        Stunned
                                    </button>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="detail-header">
                                ...
                                <div class="flex flex-col gap-1 mt-2 text-sm">
                                    ...
                                    <div>Initiative: <span x-text="selectedCombatant.initiative"
                                            class="font-bold"></span></div>
                                    <div>Conditions:
                                        <span class="font-bold"
                                            x-text="selectedCombatant.conditions || 'None'"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="detail-content">
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea x-model="selectedCombatant.conditions" class="w-full p-2 border rounded conditions-textarea"
                                        placeholder="Enter conditions (comma separated)&#10;Example: frightened 2, sickened, slowed"></textarea>
                                        ...
                                        <div class="save-rolls">
                                            ...
                                            <div class="save-buttons">
                                                <button class="save-btn"
                                                    @click="rollSave('Fortitude', selectedCombatant.fortSave || 8)">
                                                    Fortitude <span x-text="selectedCombatant.fortSave || 8"></span>
                                                </button>
                                                <button class="save-btn"
                                                    @click="rollSave('Reflex', selectedCombatant.refSave || 5)">
                                                    Reflex <span x-text="selectedCombatant.refSave || 5"></span>
                                                </button>
                                                <button class="save-btn"
                                                    @click="rollSave('Will', selectedCombatant.willSave || 7)">
                                            ...
                                            <div>
                                                <div class="mb-2 text-sm">
                                                    <strong>Class:</strong> <span
                                                        x-text="selectedCombatant.class || 'Fighter'"></span>
                                                </div>
                                                <div class="mb-2 text-sm">
                                                    <strong>Level:</strong> <span
                                                        x-text="selectedCombatant.level || '5'"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            Alpine.data('combatManager', () => ({
                ...
                saveCombatState() {
                    try {
                        ...
                        const state = {
                            ...
                            selectedCombatantId: this.selectedCombatant ? this.selectedCombatant
                                .id : null
                        };
                ...
                addPlayerCombatant() {
                    ...
                    const newPlayer = {
                        ...
                        perception: this.playerForm.perception ? `+${this.playerForm.perception}` :
                            '+0',
                ...
                rollDamage(combatant) {
                    const damageRoll = Math.floor(Math.random() * 8) + 1 + Math.floor(Math.random() *
                        8) + 1;
