...
<head>
    ...
    <title>Kobald lair Combat Manager</title>
    ...
    <div class="combat-manager" x-data="combatManager">
        ...
        <div class="header">
            <div class="header-content">
                <h1 class="header-title">Kobald lair Combat Manager</h1>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('combatManager', () => ({
                ...
                tutorialSteps: [
                    {
                        title: "Welcome to Kobald lair Combat Manager",
                        content: "This tutorial will guide you through the main features of the Kobald lair Combat Manager.<br><br>You'll learn how to add combatants, manage turns, track HP, and use dice rollers.",
                        element: null
                    },
                    {
                    ...
                    iframeDoc.write(`
                        ...
                        <body>
                            ...
                            <div style="text-align:center;margin-top:5mm">
                                Generated by Kobald lair Combat Manager
                            </div>
                        </body>
                        </html>
                    `);
