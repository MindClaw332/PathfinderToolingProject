...
<body class="bg-primary">
    <div class="container mx-auto p-8">
        ...
        <div class="bg-secondary border border-accent rounded-lg mb-8">
            <div class="p-6">
                <h1 class="text-2xl font-bold text-white">About Kobold Lair</h1>
                <p class="text-white">A powerful tool for managing your Pathfinder 2e encounters</p>
            </div>
        </div>
        ...
        <div class="bg-secondary border border-accent rounded-lg">
            <div class="p-6">
                <div class="text-white mb-8">
                    ...
                    <p>Kobold Lair was created to streamline the combat experience in Pathfinder 2e, making it easier for Game Masters to run exciting and dynamic encounters while keeping track of all the important details.</p>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-tertiary p-6 rounded-lg text-center">
                            ...
                            <p class="text-accent">Full stack develper backend </p>
                        ...
                        <div class="bg-tertiary p-6 rounded-lg text-center">
                            ...
                            <h3 class="text-white font-bold">Zoe Dreessen</h3>
                            <p class="text-accent">Full stack develper encounter creator</p>
                        ...
                        <div class="bg-tertiary p-6 rounded-lg text-center">
                            ...
                            <p class="text-accent">Full stack develper combat manager</p>
